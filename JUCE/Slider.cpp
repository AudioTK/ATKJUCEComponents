...
namespace juce
{
SliderComponent::SliderComponent(::juce::AudioProcessorValueTreeState& paramState,
    const std::string& name,
    const std::string& display,
    ImageLookAndFeel* laf)
  : levelSlider(::juce::Slider::SliderStyle::Rotary, ::juce::Slider::TextEntryBoxPosition::NoTextBox)
{
...
{
  levelSlider.setBoundsRelative(0, 0, 1, 1);
}
} // namespace juce
} // namespace ATK
