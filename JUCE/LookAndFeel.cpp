...
namespace ATK
{
  namespace juce
  {
    ...
    void SimpleSliderLookAndFeel::drawRotarySlider (::juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
    ...
    void DualSliderLookAndFeel::drawRotarySlider (::juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                                    const float rotaryStartAngle, const float rotaryEndAngle, ::juce::Slider& slider)
    {
      const float radius = std::min (width / 2, height / 2) - 2.0f;
      const float centreX = x + width * 0.5f;
