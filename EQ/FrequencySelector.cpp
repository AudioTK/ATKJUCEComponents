...
FrequencySelectorComponent::FrequencySelectorComponent(
    ...
    : frequencySlider(::juce::Slider::SliderStyle::Rotary,
      ...
      color(::juce::Colour(36, 36, 36))
{
    ...
    frequencyAtt.reset(
        new ::juce::AudioProcessorValueTreeState::SliderAttachment(
            paramState, name, frequencySlider));
    frequencySlider.setTextValueSuffix(" Hz");
    frequencySlider.setColour(::juce::Slider::rotarySliderFillColourId,
                              ::juce::Colours::lightyellow);
    frequencySlider.setLookAndFeel(&SimpleSliderLookAndFeel::get_instance());

    addAndMakeVisible(frequencyLabel);
    frequencyLabel.setText(display,
