...
PowerFilterComponent::PowerFilterComponent(
    ...
    : powerSlider(::juce::Slider::SliderStyle::Rotary,
                  ::juce::Slider::TextEntryBoxPosition::TextBoxBelow),
      color(::juce::Colour(16, 16, 16))
{
    addAndMakeVisible(powerSlider);
    powerAtt.reset(new ::juce::AudioProcessorValueTreeState::SliderAttachment(
        paramState, powerName, powerSlider));
    powerSlider.setTextValueSuffix(" ms");
    powerSlider.setColour(::juce::Slider::rotarySliderFillColourId,
