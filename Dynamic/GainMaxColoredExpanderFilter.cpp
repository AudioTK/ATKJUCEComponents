...
void GainMaxColoredExpanderFilterComponent::resized()
{
    ...
    softnessSlider.setBoundsRelative(2.1 / nb_elements, 0.2, 0.8 / nb_elements,
                                     0.7);
    colorLabel.setBoundsRelative(3.1 / nb_elements, 0.05, 0.8 / nb_elements,
                                 0.1);
    colorSlider.setBoundsRelative(3.1 / nb_elements, 0.2, 0.8 / nb_elements,
                                  0.7);
    qualityLabel.setBoundsRelative(4.1 / nb_elements, 0.05, 0.8 / nb_elements,
                                   0.1);
    qualitySlider.setBoundsRelative(4.1 / nb_elements, 0.2, 0.8 / nb_elements,
                                    0.7);
    reducLabel.setBoundsRelative(5.1 / nb_elements, 0.05, 0.8 / nb_elements,
                                 0.1);
    reducSlider.setBoundsRelative(5.1 / nb_elements, 0.2, 0.8 / nb_elements,
                                  0.7);
}
} // namespace juce
} // namespace ATK
